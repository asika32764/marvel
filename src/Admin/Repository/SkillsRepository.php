...
/**
 * The SkillsRepository class.
 *
 * @since  1.0
 */
class SkillsRepository extends ListRepository
{
    /**
     * Property name.
     *
    ...
    {
        $this->addTable('skill', Table::SKILLS)
            ->leftJoin('user', Table::USERS, 'user.id = skill.created_by');
    }
