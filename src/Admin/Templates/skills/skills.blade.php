...
@section('admin-body')
    <div id="phoenix-admin" class="skills-container grid-container">
        <form name="admin-form" id="admin-form" action="{{ $router->route('skills') }}" method="POST"
                    ...
                    <table class="table table-striped table-bordered table-responsive">
                        ...
                        <tr>
                            ...
                            <th width="10%" class="text-nowrap">
                                {!! $grid->sortTitle('admin.skill.field.author', 'skill.created_by') !!}
                            </th>
                        ...
                        @foreach ($items as $i => $item)
                            ...
                            <span class="btn-group">
                                ...
                                {{-- TITLE --}}
                                <td>
                                    <a href="{{ $router->route('skill', ['id' => $item->id]) }}">
                                        {{ $item->title }}
                                    </a>
                                </td>
                        ...
                        <tr>
                            {{-- PAGINATION --}}
                            <td colspan="25">
                                {!! $pagination->route('skills', [])->render() !!}
                            </td>
                        </tr>
                        </tfoot>
                    </table>
