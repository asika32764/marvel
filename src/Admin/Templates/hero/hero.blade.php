...
@section('admin-body')
    <form name="admin-form" id="admin-form" action="{{ $router->route('hero', ['id' => $item->id]) }}" method="POST"
        enctype="multipart/form-data">

        <div class="row">
            <div class="col-md-7">
                <fieldset id="fieldset-basic" class="form-horizontal">
                    <legend>@lang('admin.hero.edit.fieldset.basic')</legend>

                    {!! $form->renderFields('basic') !!}
                </fieldset>

                <fieldset id="fieldset-text" class="form-horizontal">
                    <legend>@lang('admin.hero.edit.fieldset.text')</legend>
            ...
            <div class="col-md-5">
                <fieldset id="fieldset-created" class="form-horizontal">
                    <legend>@lang('admin.hero.edit.fieldset.created')</legend>
