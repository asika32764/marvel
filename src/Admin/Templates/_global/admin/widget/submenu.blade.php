...
<ul id="submenu" class="nav nav-stacked nav-pills flex-column">
    ...
    <li class="nav-item {{ $helper->menu->active('heros') }}">
        <a href="{{ $router->route('heros') }}" class="nav-link {{ $helper->menu->active('heros') }}">
            @lang('admin.heros.title')
        </a>
    </li>

    <li class="nav-item {{ $helper->menu->active('skills') }}">
        <a href="{{ $router->route('skills') }}" class="nav-link {{ $helper->menu->active('skills') }}">
            @lang('admin.skills.title')
        </a>
    </li>
