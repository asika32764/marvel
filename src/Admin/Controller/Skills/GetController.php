...
use Admin\Repository\SkillsRepository;
use Admin\View\Skills\SkillsHtmlView;
...
class GetController extends ListDisplayController
{
     ...
     * @var  string
     */
    protected $defaultOrdering = 'skill.id';
