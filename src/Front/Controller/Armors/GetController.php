...
namespace Front\Controller\Armors;

use Front\Repository\ArmorsRepository;
use Front\View\Armors\ArmorsHtmlView;
...
class GetController extends ListDisplayController
{
     ...
     *
     * @var  ArmorsRepository
     */
    protected $repository = 'Armors';
     ...
     * @var  string
     */
    protected $defaultOrdering = 'armor.id';
    ...
    {
        /**
         * @var $view       ArmorsHtmlView
         * @var $repository ArmorsRepository
         */
