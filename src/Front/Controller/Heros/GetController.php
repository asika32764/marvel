...
namespace Front\Controller\Heros;

use Front\Repository\HerosRepository;
use Front\View\Heros\HerosHtmlView;
...
class GetController extends ListDisplayController
{
     ...
     * @var  string
     */
    protected $defaultOrdering = 'hero.id';
    ...
    {
        /**
         * @var $view       HerosHtmlView
         * @var $repository HerosRepository
         */
